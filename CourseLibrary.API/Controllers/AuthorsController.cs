...
public class AuthorsController : ControllerBase
{
    ...
    [RequestHeaderMatchesMediaType("Accept",
        "application/json",
        "application/vnd.rhoff.author.friendly+json")]
    ...
    [RequestHeaderMatchesMediaType("Accept",
        "application/vnd.rhoff.hateoas+json",
        "application/vnd.rhoff.author.friendly.hateoas+json")]
    [Produces("application/vnd.rhoff.hateoas+json",
        "application/vnd.rhoff.author.friendly.hateoas+json")]
    [HttpGet("{authorId}")]
    ...
    [RequestHeaderMatchesMediaType("Accept",
        "application/vnd.rhoff.author.full+json")]
    [Produces("application/vnd.rhoff.author.full+json")]
    [HttpGet("{authorId}", Name = "GetAuthor")]
    ...
    [RequestHeaderMatchesMediaType("Accept",
        "application/vnd.rhoff.author.full.hateoas+json")]
    [Produces("application/vnd.rhoff.author.full.hateoas+json")]
    [HttpGet("{authorId}")]
    ...
    //    // full author
    //    if (primaryMediaType == "vnd.rhoff.author.full")
    //    {
    //        var fullResourceToReturn = _mapper.Map<AuthorFullDto>(authorFromRepo)
    //            .ShapeData(fields) as IDictionary<string, object?>;
    ...
    [RequestHeaderMatchesMediaType("Content-Type",
            "application/vnd.rhoff.authorforcreationwithdateofdeath+json")]
    [Consumes("application/vnd.rhoff.authorforcreationwithdateofdeath+json")]
    ...
    [RequestHeaderMatchesMediaType("Content-Type",
            "application/json",
            "application/vnd.rhoff.authorforcreation+json")]
